...
class IncomeTypeController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'code', 'short_name', 'name', 'tax', 'soc_ins', 'in_status', 'accu', 'abs', 'deci', 'tax_local', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'code', 'short_name', 'name', 'tax', 'soc_ins', 'in_status', 'accu', 'abs', 'deci', 'tax_local', 'create_by', 'update_by', 'created_at', 'updated_at');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $Item->soc_ins = $request->soc_ins;
            $Item->in_status = $request->in_status;
            $Item->accu = $request->accu;
            $Item->abs = $request->abs;
            $Item->deci = $request->deci;
            $Item->tax_local = $request->tax_local;
            $Item->status = true;
