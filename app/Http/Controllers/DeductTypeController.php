...
class DeductTypeController extends Controller
{
    ...
    public function getPage(Request $request)
    {
        ...
        $col = array('id', 'code', 'short_name', 'name', 'tax', 'soc_ins', 'de_status', 'accu', 'abs', 'deci', 'tax_local', 'create_by', 'update_by', 'created_at', 'updated_at');

        $orderby = array('', 'code', 'short_name', 'name', 'tax', 'soc_ins', 'de_status', 'accu', 'abs', 'deci', 'tax_local', 'create_by', 'update_by', 'created_at', 'updated_at');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $Item->de_status = $request->de_status;
